...
class MainScreen(arcade.View):
    ...
    def on_show(self):
        self.background = arcade.load_texture("funny.png")

    def on_draw(self):
        arcade.start_render()
        arcade.draw_text("Fai and Supplex family Tree!", SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 + 50, arcade.color.GOLD, 20, anchor_x="center")
        ...
        arcade.draw_text("Kick the Baby!", SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 25, arcade.color.BLACK, 14, anchor_x="center")
        arcade.draw_text("Made by Isse!", 400, 600, arcade.color.GOLD, 20 )
        arcade.draw_text("Look at that ugly ahh baby", 250, 350,arcade.color.WHITE, 25)
